...
/**
 * @author nujwoo
 * A radio button handler to set appropriate path to input files' directory.
 */
public class RCPRadioButtonAction extends AbstractAction 
{
	private MainFrame gui;
	
	public RCPRadioButtonAction(JRadioButton radiobutton, MainFrame gui) 
	{
